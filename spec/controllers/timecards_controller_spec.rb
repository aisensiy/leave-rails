...
RSpec.describe TimecardsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all timecards as @timecards" do
      ...
      expect(assigns(:timecards)).to eq([timecard])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested timecard as @timecard" do
      ...
      expect(assigns(:timecard)).to eq(timecard)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new timecard as @timecard" do
      ...
      expect(assigns(:timecard)).to be_a_new(Timecard)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created timecard as @timecard" do
        post :create, {:timecard => valid_attributes}, valid_session
        expect(assigns(:timecard)).to be_a(Timecard)
        expect(assigns(:timecard)).to be_persisted
      end

      it "redirects to the created timecard" do
        post :create, {:timecard => valid_attributes}, valid_session
        expect(response).to redirect_to(Timecard.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved timecard as @timecard" do
        post :create, {:timecard => invalid_attributes}, valid_session
        expect(assigns(:timecard)).to be_a_new(Timecard)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested timecard" do
        timecard = Timecard.create! valid_attributes
        put :update, {:id => timecard.to_param, :timecard => new_attributes}, valid_session
        timecard.reload
      ...
      it "redirects to the timecard" do
        timecard = Timecard.create! valid_attributes
        put :update, {:id => timecard.to_param, :timecard => valid_attributes}, valid_session
        expect(response).to redirect_to(timecard)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the timecard as @timecard" do
        timecard = Timecard.create! valid_attributes
        put :update, {:id => timecard.to_param, :timecard => invalid_attributes}, valid_session
        expect(assigns(:timecard)).to eq(timecard)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the timecards list" do
      timecard = Timecard.create! valid_attributes
      delete :destroy, {:id => timecard.to_param}, valid_session
      expect(response).to redirect_to(timecards_url)
    end
  end
